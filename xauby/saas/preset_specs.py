...
PRESET_SPECS = [
    ...
    {
        "id": "binance-th-btcusdt-supertrend-v1",
        "target_id": "binance-th-spot-usdt",
        "label": "BTC/USDT Supertrend EMA200 · Binance TH",
        "exchange_id": "binance_th",
        "market_type": "spot",
        "symbol": "BTCUSDT",
        "asset": "BTC",
        ...
        "strategy_traits": [
            "Spot long only · 1×",
            "1H entries · D1 regime gate",
            "Stop protected · SuperTrend / EMA200 exits",
            "SIM only until Binance TH native certification passes",
        ],
    },
    {
        "id": "binance-th-xautusdt-actionzone-v1",
        "target_id": "binance-th-spot-usdt",
        "label": "XAUT/USDT ActionZone · Binance TH",
        "exchange_id": "binance_th",
        "market_type": "spot",
        "symbol": "XAUTUSDT",
        "asset": "XAUT",
        ...
        "strategy_traits": [
            "Spot long only · 1×",
            "4H entries · D1 regime gate",
            "Stop protected; CDC Pure no-stop exception is not portable",
            "SIM only until 12 months of Binance TH native evidence",
        ],
    },
    {
    ...
    {
        "id": "okx-btc-supertrend-long-d1-v1",
        "target_id": "okx-swap",
        "label": "BTC Supertrend · LONG D1 Challenger",
        "exchange_id": "okx",
        "market_type": "swap",
        "symbol": "BTCUSDT",
        "asset": "BTC",
        ...
        "risk_pct": 0.02,
        "max_position_per_trade_pct": 25.0,
        # Frozen research Challenger selected by the 576-cell OKX grid.  It is
        # deliberately not live-approved, and it cannot enter a Strategy Arena
        # until the pre-registered finalist protocol issues a matching record.
        "live_certified": False,
        "stop_loss_required": True,
        "execution_profile": {
            "enable_short": True,
        ...
        "strategy_traits": [
            "Research Challenger · not approved for live trading",
            "4H long + short · D1 gate applies to LONG entries only",
            "All structural and exit settings match the BTC Champion",
            "Requires finalist certification plus 30d / 20-trade forward shadow",
        ],
    },
    {
